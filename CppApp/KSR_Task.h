...
class KSR_Task :public TestTask {
...
public:
    void set_params(double _k, double _k_with_star, double _c, double _m); // Параметры для уравнения

    KSR_Task(const double& _A, const double& _B, const double& _STEP, const double& _E_ERROR,
    ...
    std::list<double> get_ERRORS_LIST();
